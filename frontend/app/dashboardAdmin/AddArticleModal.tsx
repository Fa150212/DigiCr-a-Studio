...
//         <input name="title" onChange={handleChange} placeholder="Titre" className="border p-2 w-full mb-2" />
//         <input name="date" type="date" onChange={handleChange} className="border p-2 w-full mb-2" />
//         <textarea name="description" onChange={handleChange} placeholder="Description" className="border p-2 w-full mb-2" />
//         <textarea name="content" onChange={handleChange} placeholder="Contenu" className="border p-2 w-full mb-2" />
//         <input type="file" accept="image/*" onChange={handleImageChange} />
